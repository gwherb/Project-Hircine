...
# Function for converting the objects depth and angle to coordinates
...
# Function for converting longitude and latitude to cartesian coordinates
...
# Function for converting cartesian coordinates to longitude and latitude
...
# Function for decoding images from base64
def img_decode(img):
    # decode bytes
...
# Function for encoding images to HTML format
def img_toHTML(img):
...
# Function for checking whether an object is within the field of view; also gets the distance and angle of the object relative to an external viewer
...
# Function for scaling the objects detected based on relative distance from detector/viewer and size of detection
...
# Function for overlaying the detections on the frame
...
# Function for applying a blue color gradient depending on the time of the detection
...
# Function for overlaying the detection image onto the viewers frame
...
# Function for converting the frame to base64
def convert_frame_to_base64(frame):
    _, buffer = cv2.imencode('.jpg', frame)
    frame_base64 = base64.b64encode(buffer).decode('utf-8')
    return frame_base64

# Function for converting angles from Compass angles to Cartesian angless
